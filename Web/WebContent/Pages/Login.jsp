...
<h1 align="center" class="style4" >&nbsp;</h1>
 ...
 <form action="http://localhost:8080/BetAndUinWeb/WebServer" method="post" name="form1" id="form1">
          ...
          <tr style="vertical-align: top">
			...
			<br />
              ...
              <h5>
                ...
                <a href="Register/Register.html" class="style20">Not Registed?</a></h5></td>
